...
/**
  ...
  * @version 0.5
  */
private[bertspark] final object SerDe {
  final val logger: Logger = LoggerFactory.getLogger("SerDe")

  final val serDePrefix = "org.mlops.kafka.serde"
